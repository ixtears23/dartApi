...
public class BaedangeGwanhanSahangControllerTest {
    ...
    public BaedangeGwanhanSahangControllerTest() {
    }
    ...
    @Test
    public void baedangeGwanhanSahangTest() throws Exception {
        ...
        ResultActions resultAction = mockMvc.perform(post("/baedangeGwanhanSahang")
        ...
        resultAction.andExpect(status().isOk())
                .andDo(restDocumentationResultHandler.document(
                        ...
                        responseFields(
                                ...
                                fieldWithPath("list.[].stock_knd").type(JsonFieldType.STRING).optional().description("주식 종류"),
                                fieldWithPath("list.[].thstrm").type(JsonFieldType.STRING).description("당기"),
                                fieldWithPath("list.[].frmtrm").type(JsonFieldType.STRING).description("전기"),
                                fieldWithPath("list.[].lwfr").type(JsonFieldType.STRING).description("전전기")
                        )
                ));
    }
}
