...
import person.junseok.dart.api.main.dto.SoaegJujuHyeonhwangDTO;

@RestController
public class SoaegJujuHyeonhwangController {

    private final RestTemplate restTemplate;

    private static final String REST_URL = "https://opendart.fss.or.kr/api/mrhlSttus.json";

    public SoaegJujuHyeonhwangController(RestTemplate restTemplate) {
        this.restTemplate = restTemplate;
    }

    @PostMapping("/soaegJujuHyeonhwang")
    public MainResponseBodyDTO<SoaegJujuHyeonhwangDTO> soaegJujuHyeonhwang(@RequestBody SaeobBogoseoRequestDTO saeobBogoseoRequestDTO) {
