...
public class ImwonHyeonhwangControllerTest {
    ...
    public ImwonHyeonhwangControllerTest() {
    }
    ...
    @Test
    public void imwonHyeonhwangTest() throws Exception {
        ...
        ResultActions resultAction = mockMvc.perform(post("/imwonHyeonhwang")
        ...
        resultAction.andExpect(status().isOk())
                .andDo(restDocumentationResultHandler.document(
                        requestFields(
                                attributes(key("title").value("임원현황")),
                        ...
                        responseFields(
                                ...
                                fieldWithPath("list.[].birth_ym").type(JsonFieldType.STRING).description("출생 낸월"),
                                fieldWithPath("list.[].ofcps").type(JsonFieldType.STRING).description("직위"),
                                fieldWithPath("list.[].rgist_exctv_at").type(JsonFieldType.STRING).description("등기 임원 여부"),
                                fieldWithPath("list.[].fte_at").type(JsonFieldType.STRING).description("상근 여부"),
                                fieldWithPath("list.[].chrg_job").type(JsonFieldType.STRING).description("담당 업무"),
                                fieldWithPath("list.[].main_career").type(JsonFieldType.STRING).description("주요 경력"),
                                fieldWithPath("list.[].mxmm_shrholdr_relate").type(JsonFieldType.STRING).description("최대 주주 관계"),
                                fieldWithPath("list.[].hffc_pd").type(JsonFieldType.STRING).description("재직 기간"),
                                fieldWithPath("list.[].tenure_end_on").type(JsonFieldType.STRING).description("임기 만료 일")
                        )
                ));
    }
}
