...
public class IsaGamsaJeoncheBosuHyeonhwangControllerTest {
    ...
    public IsaGamsaJeoncheBosuHyeonhwangControllerTest() {
    }
        ...
        resultAction.andExpect(status().isOk())
                .andDo(restDocumentationResultHandler.document(
                        ...
                        responseFields(
                                ...
                                fieldWithPath("list.[].nmpr").type(JsonFieldType.STRING).description("인원수"),
                                fieldWithPath("list.[].mendng_totamt").type(JsonFieldType.STRING).optional().description("보수 총액"),
                                fieldWithPath("list.[].jan_avrg_mendng_am").type(JsonFieldType.STRING).description("1인 평균 보수 액"),
