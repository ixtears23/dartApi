...
@RestController
public class IsaGamsaJeoncheBosuHyeonhwangController {

    private final RestTemplate restTemplate;

    private static final String REST_URL = "https://opendart.fss.or.kr/api/hmvAuditAllSttus.json";

    public IsaGamsaJeoncheBosuHyeonhwangController(RestTemplate restTemplate) {
        this.restTemplate = restTemplate;
    }

    @PostMapping("/isaGamsaJeoncheBosuHyeonhwang")
    public MainResponseBodyDTO<IsaGamsaJeoncheBosuHyeonhwangDTO> isaGamsaJeoncheBosuHyeonhwang(@RequestBody SaeobBogoseoRequestDTO saeobBogoseoRequestDTO) {
